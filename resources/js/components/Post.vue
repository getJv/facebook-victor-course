<template>
  <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
    ...
    <div class="flex justify-between border-1 border-gray-400 m-4">
      <button
        class="flex justify-center py-2 text-sm w-full focus:outline-none"
      ...
      <button
        class="flex justify-center py-2 text-sm text-gray-600 w-full focus:outline-none"
    ...
    <div v-if="comments" class="border-t border-gray-400 p-4 pt-2">
      ...
      >
        ...
        <div class="ml-4 flex-1">
          <div class="bg-gray-200 roundedd-lg p-2 text-sm rounded">
            <a
          ...
          <div class="text-xs pl-2">{{ comment.data.attributes.commented_at }}</div>
        </div>
      </div>
    </div>
  </div>
